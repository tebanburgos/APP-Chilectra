    ...
    right: -15px;
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="row">
							  <div class="col-md-12">	
								<form role="form" action="<?php echo site_url('etapa_v2/revision_de_propuesta/'.$this->uri->segment(3)); ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data" id="formulario_etapa_4" name="formulario_etapa_4">
								...
								<div class="col-md-6">
								  ...
								  <div class="form-group">
									...
									<input type="text" class="form-control" id="margen" name="margen" placeholder="Ej: 10,01" onkeypress="javascript:return validarNro(event)" required>
								  </div>
								  <div class="form-group">

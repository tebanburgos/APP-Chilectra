    ...
    right: -15px;
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="row">
							  <div class="col-md-12">	
								<form role="form" action="<?php echo site_url('etapa_v2/capacitacion/'.$this->uri->segment(3)); ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data" id="formulario_etapa_17" name="formulario_etapa_17">
								...
								<div class="col-md-6">
								 ...
								 <div class="form-group">								 
								 	<label>
										<input type="hidden" value="0" name="acta_de_capacitacion" >
										<input type="checkbox" name="acta_de_capacitacion" value="1" >Acta de Capacitación
									</label>
								 </div>

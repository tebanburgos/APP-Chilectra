				...
				<div class="panel-body">
					...
					<div class="row">
						<div class="col-md-6">						
							<div class="panel panel-default panel-login">
								...
								<div class="panel-body">
									...
									<form action="<?php echo site_url('usuario/recuperar_clave'); ?>" method="POST">
										<div class="row-fluid">
										<div class="span12">
										<form>
						...
						<div class="col-md-6">						
							...
							<img src="http://chilectra.s2.imacom.cl/app/assets/img/logo.png" style="width: 50%; height: 50%; margin-right: -80px; margin-left: -9px; float: right; margin-top: -15px;">
						</div>
					</div>
				</div>
			</div>
